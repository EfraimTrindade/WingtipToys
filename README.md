...
O WingtipToys é uma aplicação de comércio eletrônico fictícia que demonstra os principais recursos do ASP.NET Web Forms e do Entity Framework 6, servindo como referência para aprendizado e estudo.
...
🚀 Como executar
Abra o projeto no Visual Studio (2017 ou superior).

Certifique-se de ter o SQL Server LocalDB instalado.

Ajuste a connection string WingtipToys no Web.config se necessário.

Pressione F5 para compilar e executar.

A aplicação será carregada no navegador, simulando uma loja online de brinquedos.
